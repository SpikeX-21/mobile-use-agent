...
class ExperimentRecordTests(unittest.TestCase):
    ...
    def test_writes_comparable_jsonl_without_screenshots_or_secrets(self):
        secret_samples = {
            ...
            "X-HW-AgentGateway-Workload-Access-Token": "abc123",
            "adb_private_key": "-----BEGIN PRIVATE KEY-----secret",
            "screenshot": "data:image/png;base64,private-screen",
            "bare_image_base64": "iVBORw0KGgoAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA",
            "other_data_url": "data:application/octet-stream;base64,private-screen",
            "private_path": "/home/runtime/private.jks",
            "api_header": "X-API-Key: private-gateway-key",
